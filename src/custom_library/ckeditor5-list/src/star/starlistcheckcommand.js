...
/**
 * @module list/starlistcheckedcommand
 */

import Command from '@ckeditor/ckeditor5-core/src/command';

const attributeKey = 'starListChecked';

/**
 * @extends module:core/command~Command
 */
export default class StarListCheckCommand extends Command {
	/**
	 * @inheritDoc
	 */
	constructor( editor ) {
	...
	refresh() {
		...
		this.value = this._selectedElements.every( element => !!element.getAttribute( 'starListChecked' ) );
