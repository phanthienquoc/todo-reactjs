...
/**
 * @module list/dashlistcheckedcommand
 */

import Command from '@ckeditor/ckeditor5-core/src/command';

const attributeKey = 'dashListChecked';

/**
 * @extends module:core/command~Command
 */
export default class DashListCheckCommand extends Command {
	/**
	 * @inheritDoc
	 */
	constructor( editor ) {
	...
	refresh() {
		...
		this.value = this._selectedElements.every( element => !!element.getAttribute( 'dashListChecked' ) );
